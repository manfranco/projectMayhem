...
function profilefield_file_pluginfile($course, $cm, context $context, $filearea, $args, $forcedownload) {
    global $DB, $USER;
    //Si el nivel de permisos del usuario es diferente a CONTEXT_USER
    ...
    //genera la separacion en la url por / es como un tokenizer que deja el texto
    $relativepath = implode('/', $args);
    //genera la url de acceso al pligin. 
